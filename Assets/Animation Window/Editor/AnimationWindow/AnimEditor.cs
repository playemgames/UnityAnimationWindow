...
namespace UnityEditor.PlayEm
{
    ...
    internal class AnimEditor : ScriptableObject
    {
        ...
        internal static PrefColor kEulerXColor = new PrefColor("PlayEm/EulerX", 1.0f, 0.0f, 1.0f, 1.0f);
        internal static PrefColor kEulerYColor = new PrefColor("PlayEm/EulerY", 1.0f, 1.0f, 0.0f, 1.0f);
        internal static PrefColor kEulerZColor = new PrefColor("PlayEm/EulerZ", 0.0f, 1.0f, 1.0f, 1.0f);
        ...
        internal const int kHierarchyMinWidth = 600;
        ...
        {
            var animationWindow = (PlayEmAnimationWindow)args.context;
        ...
        [FormerlyPrefKeyAs("PlayEm/Show Curves", "c")]
        [Shortcut("PlayEm/Show Curves", typeof(PlayEmAnimationWindow), KeyCode.C)]
        static void ShowCurves(ShortcutArguments args)
        {
            ExecuteShortcut(args, animEditor => { animEditor.SwitchBetweenCurvesAndDopesheet(); });
        }

        [FormerlyPrefKeyAs("PlayEm/Play Animation", " ")]
        [Shortcut("PlayEm/Play Animation", typeof(PlayEmAnimationWindow), KeyCode.Space)]
        ...
        [FormerlyPrefKeyAs("PlayEm/Next Frame", ".")]
        [Shortcut("PlayEm/Next Frame", typeof(PlayEmAnimationWindow), KeyCode.Period)]
        static void NextFrame(ShortcutArguments args)
        {
            ExecuteShortcut(args, controlInterface => controlInterface.GoToNextFrame());
        }

        [FormerlyPrefKeyAs("PlayEm/Previous Frame", ",")]
        [Shortcut("PlayEm/Previous Frame", typeof(PlayEmAnimationWindow), KeyCode.Comma)]
        static void PreviousFrame(ShortcutArguments args)
        {
            ExecuteShortcut(args, controlInterface => controlInterface.GoToPreviousFrame());
        }

        [FormerlyPrefKeyAs("PlayEm/Previous Keyframe", "&,")]
        [Shortcut("PlayEm/Previous Keyframe", typeof(PlayEmAnimationWindow), KeyCode.Comma, ShortcutModifiers.Alt)]
        ...
        [FormerlyPrefKeyAs("PlayEm/Next Keyframe", "&.")]
        [Shortcut("PlayEm/Next Keyframe", typeof(PlayEmAnimationWindow), KeyCode.Period, ShortcutModifiers.Alt)]
        static void NextKeyFrame(ShortcutArguments args)
        {
            ExecuteShortcut(args, controlInterface => controlInterface.GoToNextKeyframe());
        }

        [FormerlyPrefKeyAs("PlayEm/First Keyframe", "#,")]
        [Shortcut("PlayEm/First Keyframe", typeof(PlayEmAnimationWindow), KeyCode.Comma, ShortcutModifiers.Shift)]
        static void FirstKeyFrame(ShortcutArguments args)
        {
            ExecuteShortcut(args, controlInterface => controlInterface.GoToFirstKeyframe());
        }

        [FormerlyPrefKeyAs("PlayEm/Last Keyframe", "#.")]
        [Shortcut("PlayEm/Last Keyframe", typeof(PlayEmAnimationWindow), KeyCode.Period, ShortcutModifiers.Shift)]
        static void LastKeyFrame(ShortcutArguments args)
        {
            ExecuteShortcut(args, controlInterface => controlInterface.GoToLastKeyframe());
        }

        [FormerlyPrefKeyAs("PlayEm/Key Selected", "k")]
        [Shortcut("PlayEm/Key Selected", null, KeyCode.K)]
        static void KeySelected(ShortcutArguments args)
        {
            PlayEmAnimationWindow animationWindow = PlayEmAnimationWindow.GetAllAnimationWindows().Find(aw => (aw.state.previewing || aw == EditorWindow.focusedWindow));
        ...
        [FormerlyPrefKeyAs("PlayEm/Key Modified", "#k")]
        [Shortcut("PlayEm/Key Modified", null, KeyCode.K, ShortcutModifiers.Shift)]
        ...
        [Shortcut("PlayEm/Toggle Ripple", typeof(PlayEmAnimationWindow), KeyCode.Alpha2, ShortcutModifiers.Shift)]
        ...
        [ClutchShortcut("PlayEm/Ripple (Clutch)", typeof(PlayEmAnimationWindow), KeyCode.Alpha2)]
        ...
        [Shortcut("PlayEm/Frame All", typeof(PlayEmAnimationWindow), KeyCode.A)]
