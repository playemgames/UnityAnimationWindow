...
namespace UnityEditor.PlayEm {
	...
	internal class AnimEditor : ScriptableObject {
		...
		[Shortcut("PlayEm/Toggle Loop", typeof(PlayEmAnimationWindow), KeyCode.L)]
		...
		[Shortcut("PlayEm/Toggle Play from the beginning", typeof(PlayEmAnimationWindow), KeyCode.B)]
