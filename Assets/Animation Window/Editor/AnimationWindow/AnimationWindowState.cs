...
using AnimEditor = UnityEditor.PlayEm.AnimEditor;
...
namespace UnityEditorInternal.PlayEm
{
    ...
    internal class AnimationWindowState : ScriptableObject, ICurveEditorState
    {
        ...
        public void OnEnable()
        {
            ...
            UnityEditor.AssemblyReloadEvents.beforeAssemblyReload += PurgeSelection;
        ...
        public void CopyKeys()
        {
            ...
            if (s_KeyframeClipboard.Count > 0)
                UnityEditor.Clipboard.stringValue = string.Empty;
        }
