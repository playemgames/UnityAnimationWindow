...
using UnityEditor;
using ControlPointRenderer = UnityEditor.PlayEm.ControlPointRenderer;
using DopeSheetEditorRectangleTool = UnityEditor.PlayEm.DopeSheetEditorRectangleTool;
using AnimationWindowStyles = UnityEditor.PlayEm.AnimationWindowStyles;
using ChangedCurve = UnityEditor.PlayEm.ChangedCurve;
using CurveMenuManager = UnityEditor.PlayEm.CurveMenuManager;
using KeyIdentifier = UnityEditor.PlayEm.KeyIdentifier;
using TimeArea = UnityEditor.PlayEm.TimeArea;
using CurveUpdater = UnityEditor.PlayEm.CurveUpdater;
